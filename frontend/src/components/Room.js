...
componentWillUnmount(){
    ...
    updateShowSettings(value){
        ...
        console.log("show settings changed.")
    }
        ...
        return(
            ...
            <Grid container spacing={2}>
               ...
               <MusicPlayer {...this.state.song} />
                ...
                {/* <Grid item align="center" xs={12}>
                <Typography variant="h6" componenet='h6'>
                ...
                <Grid item align="center" xs={12}>
                <Typography variant="h6" componenet='h6'>
                        Guest Can Pause : {this.state.guestCanPause.toString().toUpperCase()}
                    </Typography>
                </Grid>

                <Grid item align="center" xs={12}>
                <Typography variant="h6" componenet='h6'>
                        Host : {this.state.isHost.toString().toUpperCase()}
                    </Typography>
                </Grid> */}
